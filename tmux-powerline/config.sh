...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="minho"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/minho/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/minho/.mailcheckrc"
# }
